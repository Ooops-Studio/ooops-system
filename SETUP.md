...
- Workspace: `@ooopsstudio/ooops-system`
- Starter package: `@ooopsstudio/core`
- Repository: `https://github.com/ooops-studio/ooops-system`
- Preset: `public-strict`
- Publish auth preference: `trusted-publishing`
- Registry strategy: `npm`
- Package access: `public`
- GitHub Actions pinning: `versions`
